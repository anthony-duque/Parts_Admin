 ...
 * @var iterable<\App\Model\Entity\MaterialType> $materialTypes
 */
?>
<div class="materialTypes index content">
    <?= $this->Html->link(__('New Material Type'), ['action' => 'add'], ['class' => 'button float-right']) ?>
